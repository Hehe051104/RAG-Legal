...
const defaultGetThinkingMessage = (isStreaming: boolean, duration?: number) => {
  if (isStreaming || duration === 0) {
    return <Shimmer className="font-medium" duration={1}>正在思考...</Shimmer>;
  }
...
export const ReasoningContent = memo(
  ({ className, children, dir, ...props }: ReasoningContentProps) => {
    ...
    const streamdownDir: "auto" | "ltr" | "rtl" | undefined =
    ...
    return (
      ...
      >
        ...
        >
          <Streamdown plugins={streamdownPlugins} dir={streamdownDir}>
            {children}
          </Streamdown>
        </div>
      </div>
